...
;; 
;; Adapted from SP466FNC0P7JWTNM2R9T199QRZN1MYEDTAR0KP27.citycoin-vrf

;; Read the on-chain VRF and turn the lower 16 bytes into a uint
(define-read-only (get-random-uint-at-block (block uint))
  (let (
    (vrf-lower-uint-opt
      (match (get-block-info? vrf-seed block)
